             ...
             <div id="shopping_cart">
                 ...
                 <?php
                   ...
                   if(!isset($_SESSION['customer_email']))
                   {
                    ...
                    echo "<a style='color:pink; text-decoration:none;'>Login:</a>
                    "; echo "<a href='checkout.php' style='color:red; text-decoration:none;'>Buyer</a>
                    ";
                    echo "      ";
                  echo "<a href='./seller_area/sell_interface_login.php' style='color:red; text-decoration:none;'>Seller</a>
                  ";
                }
