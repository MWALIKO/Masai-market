...
<html>
<head>
<title> KENYA MASAI MARKET MANAGEMENT SYSTEM</title>
...
&emsp;
                                                 ...
                                                 while($row_pro=mysqli_fetch_array($run_pro))
                                                      {
                                                       ...
                                                       echo "
                                                          ...
                                                          <div id='single_product'>
                                                                    ...
                                                                    <img src='seller_area/product_images/$pro_image' width='180' height='180' />

                                                                    <p> Ksh <b>$pro_price</b></p> 
     ...
     <!-- CONTENTS SECTION ENDS HERE -->
         ...
         <div id="footer">
                          <h2 style="text-align: center;padding-top: 10px ">&Masai Market</h2>
         </div>
