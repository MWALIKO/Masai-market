...
<body>
    ...
    <div class="main">
                                 ...
                                 $qty=$p_price['qty'];  //for test purpose
                                                ...
                                                <tr align="center">
                                                	...
                                                	<td><br><?php echo "$product_title"; ?><br>
                                                       <img src="seller_area/product_images/<?php echo "$product_image"  ?>" width="80" height="80" /> 
                                                	</td>
                                                	<td >
                                                      <br><br><br>

 
                                                        <input type="number"  ename="qty" min="1" size="" value="<?php echo 'SESSION["qty"]'; ?>" />  
                                                     ...
                                                     <?php
                                                            if(isset($_POST['update_cart'])) {
                                                                ...
                                                                // Update total and single price based on the new quantity
                                                                $total = (int)$total * (int)$qty;
                                                                $single_price = (int)$single_price * (int)$qty;
                                                            }
                                                	...
                                                	<td><br><br><br><?php echo "ksh $single_price";  ?><br></td>
                                            ...
                                            <tr align="center"> 
                                            	...
                                            	<td ><br><br><br><?php echo " ksh $total";  ?></td>
                                            ...
                                            <tr align="center">
                                            	<td><br><input type="submit" name="update_cart" value="Delete Cart"></td>
     ...
     <!-- CONTENTS SECTION ENDS HERE -->
         ...
         <div id="footer">
                          <h2 style="text-align: center;padding-top: 10px ">&copy By Masai Market</h2>
         </div>
